...
public class DatabaseConfiguration {
	...
	private void createPersonCompetitionUniqueConstraint() {
		...
		statements.add(new AddConstraint(personcompetition,
				new UniqueConstraint(columns)));
	}
	...
	private void createAll() {
		...
		addCreateChangeColumn(columns);
		addDeleteColumn(columns);
		personcompetition = new TableDefinition("personcompetition", dbType,
				columns);
	...
	private List<ColumnDefinition> createPersonCompetitionColumns() {
		ColumnDefinition colPersId = new ColumnDefinition(DataType.INTEGER,
				"person_id", "NOT NULL");
		ColumnDefinition colCompetitionId = new ColumnDefinition(
				DataType.VARCHAR100, "event_id", "NOT NULL");
		ColumnDefinition colCalendarId = new ColumnDefinition(
				DataType.VARCHAR100, "calendar_id", "NOT NULL");
		ColumnDefinition colParticipation = new ColumnDefinition(
				DataType.VARCHAR255, "participation");
		ColumnDefinition colRoutine = new ColumnDefinition(DataType.VARCHAR255,
				"routine");
		ColumnDefinition colComment = new ColumnDefinition(DataType.VARCHAR255,
				"comment");
