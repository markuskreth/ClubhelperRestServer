...
public interface Dao<T extends Data> {
	...
	/**
	 * Erstellt ein neues Objekt in der Datenbank. Id wird im rückgabeobjekt
	 * gesetzt. <br>
	 * changed und created müssen vor aufruf gesetzt sein!
	 * 
	 * @param obj
	 *            Daten des zu zu erstellenden Datenbankeintrags
	 * @return Aktualisiertes Objekt oder null, wenn update fehlgeschlagen.
	 */
	public abstract T insert(T obj);

	/**
	 * Aktualisiert den Datenbankeintrag zum Objekt. Keine werte (auch changed
	 * nicht!) werden geändert. <br>
	...
	/**
	 * Aktualisiert den Datenbankeintrag mit der angegebenen Id und setzt die
	 * Werte des Objekts. Keine werte (auch changed nicht!) werden geändert.
	 * <br>
	 * changed muss vor aufruf gesetzt sein!
	 * 
	 * @param id
	 ...
	 * 
	 * @param obj
	 *            Objekt, das gelöscht werden soll.
	 ...
	 * 
	 * @param id
	 *            id des Objekts, das gelöscht werden soll.
	 * @return true, wenn löschen erfolgreich.
	 */
