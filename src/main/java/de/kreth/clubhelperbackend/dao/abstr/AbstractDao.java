...
public abstract class AbstractDao<T extends Data> extends JdbcDaoSupport
	...
	protected static final DatabaseConfiguration dbConfig = new DatabaseConfiguration(
			0);
	...
	private String SQL_QUERY_BY_WHERE;
	...
	public List<T> getByWhere(String where) {
		return getJdbcTemplate().query(String.format(SQL_QUERY_BY_WHERE, where),
				mapper);
	}
